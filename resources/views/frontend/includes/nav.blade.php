    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            @endif
                ...
                <li class="nav-item"><a href="{{route('frontend.questions')}}" class="nav-link {{ active_class(Route::is('frontend.questions')) }}">أسئلة المقابلة</a></li>
            ...
            <li class="nav-item"><a href="{{route('frontend.contact')}}" class="nav-link {{ active_class(Route::is('frontend.contact')) }}">إتصل بنا</a></li>
        </ul>
    </div>
</nav>
